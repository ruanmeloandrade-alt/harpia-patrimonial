...
-- Permite preparar conversas WhatsApp usando o CRM normalizado como fonte principal do telefone.
...
begin
  ...
  select regexp_replace(coalesce(l.whatsapp, ''), '[^0-9]', '', 'g')
    into v_phone
  ...
  select a.id into v_channel_account_id
