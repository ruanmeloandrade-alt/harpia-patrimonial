...
const links: NavItem[] = [
  ...
  { href: '/interno/salesbot', label: 'SalesBot', permission: PERMISSIONS.SALESBOT_MANAGE },
  { href: '/interno/automatize', label: 'Automatize', permission: PERMISSIONS.AUTOMATIONS_MANAGE },
  { href: '/interno/agentes-ia', label: 'Agentes IA', permission: PERMISSIONS.AI_MANAGE },
  { href: '/interno/execucoes', label: 'Execuções', permissions: [PERMISSIONS.SALESBOT_VIEW, PERMISSIONS.AUTOMATIONS_VIEW, PERMISSIONS.AI_VIEW] },
  { href: '/interno/integracoes', label: 'Integrações', permission: PERMISSIONS.INTEGRATIONS_MANAGE },
